...
// Sequential agents — each starts after the previous completes
...
const COMPLETION_REL    = AUDIO_END + 400;      // 14300
const BUTTON_APPEAR_REL = COMPLETION_REL + 1500; // 15800
...
const AgentCard = ({
  ...
  return (
    ...
    >
        ...
        {complete ? (
          <motion.span
            ...
            style={{
              ...
              background: "#F0F0F0", color: "#2E1A47",
              whiteSpace: "nowrap",
            }}
          >
            Complete ✓
      ...
      <div
        style={{
          marginTop: 10, width: "100%", height: 4,
      ...
      >
        ...
        {!done ? (
          ...
          <motion.div
            ...
            style={{
              width: 26, height: 26, borderRadius: "50%",
              background: "#2E1A47", flexShrink: 0,
              display: "flex", alignItems: "center", justifyContent: "center",
            }}
          >
...
const IntegrationCard = ({
  ...
  const btnStyle: React.CSSProperties =
    connectState === "connected"
      ? { height: 38, padding: "0 20px", background: "#ECFDF5", border: "1px solid #BBF7D0", color: "#15803D", borderRadius: 6, fontSize: 18, fontWeight: 500, cursor: "default", transition: "all 0.3s ease" }
      : connectState === "connecting"
      ? { height: 38, padding: "0 20px", background: "#4D6BA9", border: "1px solid #4D6BA9", color: "white", borderRadius: 6, fontSize: 18, fontWeight: 500, cursor: "default", transition: "all 0.3s ease", display: "flex", alignItems: "center", gap: 6 }
      : { height: 38, padding: "0 20px", background: "white", border: "1px solid rgba(15,23,41,0.06)", color: "#334155", borderRadius: 6, fontSize: 18, fontWeight: 500, cursor: "pointer", transition: "all 0.3s ease" };
  ...
  return (
    ...
    >
      ...
      <button style={btnStyle} onClick={connectState === "idle" ? onConnect : undefined}>
        {connectState === "connecting" ? (
          <>
            <span style={{ width: 10, height: 10, border: "2px solid rgba(255,255,255,0.35)", borderTopColor: "white", borderRadius: "50%", display: "inline-block", animation: "spin 0.8s linear infinite" }} />
            Connecting...
          </>
...
const Index = () => {
  ...
  // Agent card visibility — appear one at a time
  ...
  return (
    <div className="flex min-h-screen" style={{ background: "#FFFFFF" }}>
      ...
      <main className="flex-1" style={{ marginLeft: 320, position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: 760, margin: "0 auto", padding: "32px 36px" }}>
            ...
            {scene === "upload" && (
              ...
              >
                  ...
                  {showCompletion && (
                    <motion.div
                      ...
                      style={{
                        ...
                        borderRadius: 6, padding: "6px 14px", marginBottom: 12,
                      }}
                    >
                ...
                <div style={{ marginBottom: 20 }}>
                  <p style={{ fontSize: 18, textTransform: "uppercase", color: "#4B5563", letterSpacing: "0.06em", marginBottom: 10 }}>
                    Building Data
                  </p>
                  <p style={{ fontSize: 22, fontWeight: 700, color: "#2E1A47", marginBottom: 2 }}>
                  ...
                  {!photosInDzFading && (
                    <motion.div
                      ...
                      style={{
                        ...
                        borderRadius: 12, border: "1px dashed #C0C0C0",
                        background: "#FAFAFA",
                        display: "flex", flexDirection: "column",
                        ...
                        return (
                          <motion.div
                            ...
                            style={{
                              ...
                              width: 110, height: 82, borderRadius: 8,
                ...
                {/* Agent cards — appear one at a time, stack as they complete */}
                <div style={{ display: "flex", flexDirection: "column", gap: 12, marginBottom: 16 }}>
                  {showVision && (
                    <AgentCard
                      ...
                      active={t >= VISION_START && visionProgress < 1}
                  ...
                  {showDoc && (
                    <AgentCard
                      ...
                      active={t >= DOC_START && docProgress < 1}
                  ...
                  {showAudio && (
                    <AgentCard
                      ...
                      active={t >= AUDIO_START && audioProgress < 1}
                ...
                {/* Ingestion complete summary bar */}
                <AnimatePresence>
                  {showCompletion && (
                    <motion.div
                      initial={{ opacity: 0 }}
                ...
                <AnimatePresence mode="wait">
                  ...
                  {showIntegrations && (
                    <motion.div
                      ...
                      transition={{ duration: 0.35, ease: "easeOut" }}
                    >
                      <p style={{ fontSize: 16, textTransform: "uppercase", color: "#64748B", letterSpacing: "0.08em", marginBottom: 10 }}>
                        Connect Your Tools
                      </p>
